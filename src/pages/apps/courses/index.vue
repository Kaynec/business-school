  ...
  <div class="grid">
    ...
    >
      ...
      <div class="d-flex flex-column justify-center align-center gap-2">
        ...
        <h1 style="color: white">Self leadership</h1>
      </div>
      <div class="d-flex justify-center align-center gap-2">
        <div
          class="d-flex flex-column justify-center align-center gap-4 ma-2"
          style="color: white"
        >
          <div
            style="
              padding: 0.5rem;
              border-radius: 5px;
              background: rgba(82, 174, 50, 30%);
            "
          >
            <v-icon large style="color: #52ae32">mdi-domain</v-icon>
          </div>
          <span> شروع: 1400/10/26 </span>
        </div>
        <div
          class="d-flex flex-column justify-center align-center gap-4 ma-2"
          style="color: white"
