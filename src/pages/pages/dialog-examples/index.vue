  ...
  <VRow class="match-height">
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        <VCardItem class="!flex flex-col gap-2">
          <template #prepend>
            <VIcon size="34" icon="mdi-file-document-outline" />
          </template>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        <VCardItem class="!flex flex-col gap-2">
          <template #prepend>
            <VIcon size="34" icon="mdi-credit-card-outline" />
          </template>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        <VCardItem class="!flex flex-col gap-2">
          <template #prepend>
            <VIcon size="34" icon="mdi-currency-usd" />
          </template>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        <VCardItem class="!flex flex-col gap-2">
          <template #prepend>
            <VIcon size="34" icon="mdi-gift-outline" />
          </template>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        <VCardItem class="!flex flex-col gap-2">
          <template #prepend>
            <VIcon size="34" icon="mdi-home-outline" />
          </template>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        <VCardItem class="!flex flex-col gap-2">
          <template #prepend>
            <VIcon size="34" icon="mdi-lock-outline" />
          </template>
