  ...
  <VCard title="Top Referral Sources" subtitle="82% activity growth">
    ...
    <VCardText class="pb-2">
      <VSlideGroup v-model="currentTab" show-arrows mandatory>
        ...
        <VSlideGroupItem>
          <div
            class="!flex flex-col justify-center align-center rounded me-4 not-selected-category"
            style="width: 6rem; height: 6rem"
          >
      ...
      <tbody class="text-high-emphasis">
        ...
        >
          ...
          <td class="font-weight-semibold">
            <VChip size="x-small" :color="currentProduct.status.color">
          ...
          <td>
            <span
              ...
              :class="
                Math.sign(currentProduct.conversion) > 0
                  ? 'text-success'
                  : 'text-error'
              "
            >
          ...
          <td style="width: 1rem" class="font-weight-semibold text-end">
